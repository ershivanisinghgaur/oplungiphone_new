...
public class AdapterFavorite extends ArrayAdapter<Product> {
    ...
    public AdapterFavorite(Activity activity, int resource, List<Product> arrayList) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.price.setText(object.getProductPrice());
        holder.code.setText(object.getProductCode());
